...
from goofish_omni.core.session import DEFAULT_COOKIE_PATH, write_cookies_json
...
def login(
    ...
    *,
    ...
    if qr:
        ...
        from goofish_omni.core.qr_login import login_via_qr
...
def _pull_from_browser(browser: str) -> tuple[dict[str, str], str]:
    from goofish_omni.core.browser_cookie import (
        BrowserCookieError,
        available_browsers,
