...
from goofish_omni.commands.category.recommend import recommend
from goofish_omni.commands.location.default import default as get_default_location
from goofish_omni.commands.media.upload import upload
