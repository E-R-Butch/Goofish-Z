...
from goofish_omni.core import GoofishError, iter_commands
from goofish_omni.core.output import Format, render
from goofish_omni.core.registry import Command, discover
...
def version_cmd():
    """打印版本号。"""
    from goofish_omni import __version__
