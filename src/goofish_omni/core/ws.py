...
from goofish_omni.core.sign import decrypt, generate_mid, generate_uuid
from goofish_omni.core.token import IM_APP_KEY, get_access_token
...
async def run_forever(
    ...
    *,
    ...
    """
    from goofish_omni.core.token import refresh_login
