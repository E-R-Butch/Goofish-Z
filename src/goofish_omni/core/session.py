...
cookie 路径：~/.goofish-omni/cookies.json（可用 GOOFISH_OMNI_DATA 覆盖）。
"""
...
from goofish_omni.core.errors import AuthRequiredError
from goofish_omni.core.sign import generate_device_id, generate_sign
...
class Session:
    ...
    def call_with_refresh(self, api: str, *, data: dict | None = None, **kwargs) -> dict:
        ...
        from goofish_omni.core.mtop import call as mtop_call
