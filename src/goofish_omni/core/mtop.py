...
from goofish_omni.core.session import USER_AGENT, Session
from goofish_omni.core.sign import generate_sign
...
def call(
    ...
    *,
    ...
    try:
        ...
        from goofish_omni.core.refresh import is_enabled, refresh_cookies_via_browser
        if not is_enabled():
            raise
